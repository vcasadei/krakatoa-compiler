...
public class Program {
	...
	public void genC(PW pw) {
		pw.println("/*");
		pw.println(" * Deve-se incluir alguns headers porque algumas fun��es");
		pw.println(" * da biblioteca padr�o de C s�o utilizadas na tradu��o.");
		pw.println("*/");
		...
		pw.println("");
		pw.println("/* Define um tipo Func, um ponteiro para fun��o */");
		pw.println("typedef");
		pw.add();
		...
		pw.printlnIdent(" * Crie objeto da classe Program e envie a mensagem"
				+ " run para ele.");
		pw.printlnIdent(" * Nem sempre o n�mero de run no vetor � 0.");
		pw.printlnIdent("*/");
